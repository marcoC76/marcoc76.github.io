...
<img src="https://latex.codecogs.com/svg.latex?\tau&space;=&space;Fd" title="\tau = Fd" />

Donde

<img src="https://latex.codecogs.com/svg.latex?F&space;=&space;magnitud\&space;de\&space;las\&space;fuerzas\&space;actuantes\&space;en\&space;el\&space;par" title="F = magnitud\ de\ las\ fuerzas\ actuantes\ en\ el\ par" />

<img src="https://latex.codecogs.com/svg.latex?d&space;=&space;distancia\&space;entre\&space;las\&space;dos\&space;fuerzas" title="d = distancia\ entre\ las\ dos\ fuerzas" />
...
<img src="https://latex.codecogs.com/svg.latex?d&space;=&space;60cm&space;=&space;0.6m" title="d = 60cm = 0.6m" />

<img src="https://latex.codecogs.com/svg.latex?F&space;=&space;30N" title="F = 30N" />

Formula:

<img src="https://latex.codecogs.com/svg.latex?\tau&space;=&space;Fd" title="\tau = Fd" />

<img src="https://latex.codecogs.com/svg.latex?\tau&space;=&space;\left(&space;30N&space;\right)\left(&space;0.6m&space;\right)" title="\tau = \left( 30N \right)\left( 0.6m \right)" />

<img src="https://latex.codecogs.com/svg.latex?\tau&space;=&space;18Nm" title="\tau = 18Nm" />
...
<div style="width:100%;height:0;padding-bottom:104%;position:relative;"><iframe src="https://giphy.com/embed/9qmq1WGohyFbO" width="100%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed" allowFullScreen></iframe></div><p><a href="https://giphy.com/gifs/manextreme-equilibrio-funnt-9qmq1WGohyFbO">via GIPHY</a></p>
...
<img src="https://latex.codecogs.com/svg.latex?\sum&space;\overrightarrow{F}&space;=&space;0" title="\sum \overrightarrow{F} = 0" />

En función de sus componentes:

<img src="https://latex.codecogs.com/svg.latex?\sum&space;\overrightarrow{F_{x}}&space;=&space;0" title="\sum \overrightarrow{F_{x}} = 0" />

<img src="https://latex.codecogs.com/svg.latex?\sum&space;\overrightarrow{F_{y}}&space;=&space;0" title="\sum \overrightarrow{F_{y}} = 0" />
