...
#### La página de resultados de búsqueda de Google
...
![search results page](images/image12.png)
...
> Título: la primera línea de color azul de cualquier resultado de la
...
|                                      | personas".                           |
+--------------------------------------+--------------------------------------+
| \*                                   | Agrega un asterisco como un marcador |
